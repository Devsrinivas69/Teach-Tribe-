      ...
      <div className="grid gap-8 md:grid-cols-4">
        <div>
          <Link to="/" className="flex items-center gap-2 mb-4">
            ...
            <span className="text-lg font-bold text-gradient">Academia</span>
          </Link>
          ...
          <div className="mt-4 flex gap-3">
            {[Github, Twitter, Linkedin, Youtube].map((Icon, i) => (
              <a key={i} href="#" className="rounded-full border border-border p-2 text-muted-foreground transition-colors hover:border-primary hover:text-primary">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            {['Help Center', 'Community', 'Contact Us', 'Teach on Academia'].map(l => <li key={l}><a href="#" className="hover:text-foreground">{l}</a></li>)}
          </ul>
        </div>
        <div>
